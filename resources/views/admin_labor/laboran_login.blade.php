...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow">
        <h1 class="text-2xl font-bold text-center text-gray-700">Admin Labor Login</h1>
        <p class="text-sm text-center text-gray-500 mt-2">Login to your admin_labor account</p>
        ...
        <!-- Form -->
        <form action="{{ route('adminlabor.login.submit') }}" method="POST" class="mt-6">
            <!-- CSRF Token -->
            @csrf
